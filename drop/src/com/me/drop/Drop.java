...
public class Drop implements ApplicationListener {
   ...
   private void spawnRaindrop() {
      ...
      raindrop.y = 480; //starting at the top, or at least slightly above the top
      raindrop.width = 64;
      raindrop.height = 64;
   ...
   public void render() {
      ...
      // check if we need to create a new raindrop by seeing how much time has elapsed since the last raindrop
